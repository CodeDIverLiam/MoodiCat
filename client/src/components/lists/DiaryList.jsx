        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h4 className="text-sm font-medium text-gray-800 truncate">{entry.title || '(Untitled)'}</h4>
              {entry.mood && (
            ...
            <p className="text-sm text-gray-600 line-clamp-2">{entry.content || '(No content)'}</p>
